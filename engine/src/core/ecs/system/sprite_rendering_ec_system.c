...
void sprite_rendering_system_render() {
    for (size_t i = 0; i < spriteRenderingSystem->entity_count; i++) {
        ...
        const SpriteComponent* spriteComponent =
            (SpriteComponent*) component_manager_get_component(entity, ComponentDataIndex_SPRITE);
        ...
        rbe_renderer_queue_sprite_draw_call(spriteComponent->texture, spriteComponent->drawSource, destinationRectangle,
                                            spriteTransformComp->rotation, spriteComponent->modulate,
