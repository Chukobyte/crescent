...
#define RBE_STATIC_ARRAY_ADD(ARRAY_NAME, ARRAY_VALUE) ARRAY_NAME[ARRAY_NAME##_count++] = ARRAY_VALUE
...
#define RBE_STATIC_ARRAY_EMPTY(ARRAY_NAME) ARRAY_NAME##_count = 0;
