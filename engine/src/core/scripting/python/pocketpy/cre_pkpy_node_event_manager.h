...
void cre_pkpy_node_event_manager_create_event(struct pkpy_vm_handle* vm, int ownerId, const char* eventName);
void cre_pkpy_node_event_manager_remove_entity_and_connections(struct pkpy_vm_handle* vm, int ownerId);
