...
void cre_json_particles2d_create_or_set_default(JsonSceneNode* node, cJSON* componentJson) {
    ...
    if (node->components[CreComponentDataIndex_PARTICLES_2D] == NULL) {
        ...
        particles2dComponent->initialVelocity = json_get_vec2_default(componentJson, "initial_velocity", SKA_VECTOR2_ZERO);
        ...
        particles2dComponent->initialVelocity = json_get_vec2_default(componentJson, "initial_velocity", particles2dComponent->initialVelocity);
