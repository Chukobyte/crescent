...
CORE_SRC = $(wildcard engine/src/main.c engine/src/core/*.c engine/src/core/utils/*.c engine/src/core/data_structures/*.c engine/src/core/memory/*.c engine/src/core/input/*.c engine/src/core/rendering/*.c engine/src/core/scripting/python/*.c engine/src/core/thread/*.c include/stb_image/stb_image.c include/glad/glad.c)
CORE_OBJ_C = $(CORE_SRC:.c=.o)
CORE_SRC_TEST = $(wildcard engine/src/test/main.c include/unity.c engine/src/core/*.c engine/src/core/utils/*.c engine/src/core/data_structures/*.c engine/src/core/memory/*.c engine/src/core/input/*.c engine/src/core/rendering/*.c engine/src/core/scripting/python/*.c engine/src/core/thread/*.c include/stb_image/stb_image.c include/glad/glad.c)
